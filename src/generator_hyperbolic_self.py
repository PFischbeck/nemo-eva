...
class GeneratorHyperbolicSelf(AbstractStage):
    _stage = "2-features/hyperbolic-self"

    def __init__(self, parameters, cores=1, **kwargs):
        super(GeneratorHyperbolicSelf, self).__init__()
...
def main():
    ...
    generator = GeneratorHyperbolicSelf(parameters, cores=args.cores)
    generator.execute()
