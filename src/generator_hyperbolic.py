...
from helpers.generators import fit_hyperbolic
...
class GeneratorHyperbolic(AbstractStage):
    _stage = "2-features/hyperbolic"

    def __init__(self, graph_dicts, cores=1, **kwargs):
        super(GeneratorHyperbolic, self).__init__()
...
def main():
    ...
    generator = GeneratorHyperbolic(graph_dicts, cores=args.cores)
    generator.execute()
