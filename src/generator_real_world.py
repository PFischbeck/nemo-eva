...
def _execute_one_graph(graph_dict):
    ...
    model_name = "real-world"
    model_converter = lambda g: ("", g)
...
class GeneratorRealWorld(AbstractStage):
    _stage = "2-features/real-world"

    def __init__(self, graph_dicts, cores=1, **kwargs):
        super(GeneratorRealWorld, self).__init__()
...
def main():
    ...
    generator = GeneratorRealWorld(graph_dicts, cores=args.cores)
    generator.execute()
