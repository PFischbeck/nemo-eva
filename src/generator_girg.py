...
from helpers.generators import fit_girg
...
class GeneratorGIRG(AbstractStage):
    _stage = "2-features/girg"

    def __init__(self, graph_dicts, cores=1, **kwargs):
        super(GeneratorGIRG, self).__init__()
...
def main():
    ...
    generator = GeneratorGIRG(graph_dicts, cores=args.cores)
    generator.execute()
